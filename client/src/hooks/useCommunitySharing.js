...
import { SAMPLE_REQUESTS, SAMPLE_DONATIONS } from "../components/community/sampleData";
...
export function useCommunitySharing() {
  ...
  return { requests, donations, reqLoading, donLoading, fetchRequests, fetchDonations };
}
