...
const REPORT_TYPES = [
  { id: "all", label: "All Reports", icon: "📋", color: "#6b7280" },
  { id: "flood", label: "Flood", icon: "🌊", color: "#06b6d4" },
  { id: "rescue", label: "Rescue", icon: "🆘", color: "#ef4444" },
  { id: "medical", label: "Medical", icon: "🏥", color: "#ec4899" },
  { id: "earthquake", label: "Earthquake", icon: "🏚️", color: "#f97316" },
  { id: "landslide", label: "Landslide", icon: "⛰️", color: "#8b5cf6" },
  { id: "fire", label: "Fire", icon: "🔥", color: "#dc2626" },
  { id: "other", label: "Other", icon: "⚠️", color: "#64748b" },
];
